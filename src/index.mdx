...
<img style={{height: 240 + 'px'}} src={'public/images/vtracer-demo.svg'}/>

We developed [VTracer](//www.visioncortex.org/vtracer/), a program to convert raster images (like jpg & png) into vector graphics (svg). Our graphics pipeline is able to process complex graphics as well as photographs and trace the curves to output compact vector files. The tracer features high fidelity, low redundancy and high performance.

## Optical Character Recognition

<img style={{height: 240 + 'px'}} src={'public/images/forest-layering.svg'}/>
