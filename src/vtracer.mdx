...
Author: [Sanford Pun](//github.com/shpun817) | Editor: [Chris Tsang](//github.com/tyt2y3) | Published: 2020-11-01

-----

[VTracer](//www.visioncortex.org/vtracer/) is a utility to convert raster images into vector graphics. The input image is first clustered by [Hierarchical Clustering](/visionmagic-docs), and each of the output clusters are traced into vector.
