...
[VTracer](//www.visioncortex.org/vtracer/) is a utility to convert raster images into vector graphics. The input image is first clustered by [Hierarchical Clustering](/impression-docs), and each of the output clusters are traced into vector.
